...
def main():
    ...
    # 跨股票对比参数
    parser.add_argument('--comparison_mode', choices=['top10', 'industry', 'custom', 'self_only', 'all'],
                        default='top10', help='对比模式: top10(市值前10), industry(同行业), custom(自定义), self_only(仅自身历史), all(全部A股) (默认: top10)')
