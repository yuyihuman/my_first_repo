...
class GPUBatchPearsonAnalyzer:
    ...
    def _log_first_evaluation_debug_info(self, batch_avg_correlations_filtered, batch_high_corr_mask,
        ...
        try:
            ...
            eval_fields = ['open', 'high', 'low', 'close', 'volume']
        ...
        try:
            ...
            historical_data_top = historical_tensor[top_idx_all].detach().cpu()  # [window_size, 5]
        ...
        try:
            field_indices = {'open': 0, 'close': 3, 'volume': 4}
            for field_name, field_idx in field_indices.items():
                ...
                fields_all = ['open', 'high', 'low', 'close', 'volume']
                hist_all_fields = historical_tensor[best_idx].detach().cpu()  # [window_size, 5]
